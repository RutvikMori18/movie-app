...
class ThemeText {
  ...
  static TextStyle? get _vulcanHeadline6 =>
      _whiteHeadline6?.copyWith(color: AppTheme.vulcan);

  static TextStyle? get _vulcanHeadline5 =>
      _whiteHeadline5?.copyWith(color: AppTheme.vulcan);

  static TextStyle? get vulcanSubtitle1 =>
      whiteSubtitle1?.copyWith(color: AppTheme.vulcan);

  static TextStyle? get vulcanBodyText2 =>
      whiteBodyText2?.copyWith(color: AppTheme.vulcan);
...
extension ThemeTextExtension on TextTheme {
  TextStyle? get royalBlueSubtitle1 => subtitle1?.copyWith(
      color: AppTheme.royalBlue, fontWeight: FontWeight.w600);

  TextStyle? get greySubtitle1 => subtitle1?.copyWith(color: Colors.grey);

  TextStyle? get violetHeadline6 => headline6?.copyWith(color: AppTheme.violet);

  TextStyle? get vulcanBodyText2 =>
      bodyText2?.copyWith(color: AppTheme.vulcan, fontWeight: FontWeight.w600);
